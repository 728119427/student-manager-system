...
<%--<script src="${pageContext.request.contextPath}/static/js/jquery-3.3.1.min.js"/>--%>

<script>
	$(function(){
		//点击图片切换验证码
		$("#vcodeImg").click(function(){
			this.src="system/getVcode?t="+new Date().getTime();
		});
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="${pageContext.request.contextPath}/system/getVcode"></div>
      </div>
...
<div class="footer">Copyright &nbsp; artisan @ 【黑熊噗通】 </div>
